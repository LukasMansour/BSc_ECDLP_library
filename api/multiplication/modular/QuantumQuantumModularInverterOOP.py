...
class QuantumQuantumModularInverterOOP(CircuitComponent):
    """
    This class denotes an n-bit quantum-quantum modular inverter.

    It will apply the following unitary transformation: |x>|0> to |x>|x^(-1) mod p>
    """
