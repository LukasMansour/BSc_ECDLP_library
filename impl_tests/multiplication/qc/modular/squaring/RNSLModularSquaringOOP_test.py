...
class RNSLModularSquaringOOPTests(unittest.TestCase):

    def setUp(self):
        CircuitChooser().clear_caches()

    def test_modular_squaring(self):
        ...
        for p in [7, 9, 11]:
            ...
            for i in range(0, 5):
                ...
                constant_mod_adder = RNSLModularSquaringOOP(
                    dirty_anc_available,
                    clean_anc_available,
                    n,
                    p,
