...
class CDKMComparatorTests(unittest.TestCase):
    ...
    def test_comparator(self):
        ...
        for i in range(0, 10):
            ...
            circuit.append(
                CDKMComparator(dirty_anc_available, clean_anc_available, n, 0).get_circuit(),
                list(register_x) +
                list(register_y) +
                list(register_r) +
                list(register_g) +
    ...
    def test_controlled_comparator(self):
        ...
        for i in range(0, 10):
            ...
            # Incoming carry qubit has to be added at the end, as it acts like an ancilla.
            circuit.append(
                CDKMComparator(dirty_anc_available, clean_anc_available, n, c).get_circuit(),
                list(register_c) +
                list(register_x) +
                list(register_y) +
                list(register_r) +
