...
class BasicIncrementerTests(unittest.TestCase):
    ...
    def test_addition_no_overflow(self):
        ...
        for s in range(0, 3):
            for i in range(0, 20):
                ...
                incrementer = BasicIncrementer(dirty_anc_available, clean_anc_available, n, s, 0, False)
    ...
    def test_addition_overflow(self):
        ...
        for s in range(0, 3):
            for i in range(0, 20):
                ...
                clean_anc_available = 0
                # Get circuit component.
                incrementer = BasicIncrementer(dirty_anc_available, clean_anc_available, n, s, 0, True)
    ...
    def test_controlled_addition_no_overflow(self):
        ...
        for s in range(0, 3):
            for i in range(0, 10):
                ...
                clean_anc_available = 0
                # Get circuit component.
                incrementer = BasicIncrementer(dirty_anc_available, clean_anc_available, n, s, c, False)
    ...
    def test_controlled_addition_overflow(self):
        ...
        for s in range(0, 3):
            for i in range(0, 10):
                ...
                clean_anc_available = 0
                # Get circuit component.
                incrementer = BasicIncrementer(dirty_anc_available, clean_anc_available, n, s, c, True)
