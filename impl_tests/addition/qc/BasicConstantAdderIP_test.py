...
class BasicConstantAdderTests(unittest.TestCase):
    ...
    def test_addition_gidney_incrementer(self):
        ...
        for i in range(0, 10):
            ...
            x_value = Random().randint(1, 2 ** n - 1)
            a_value = Random().randint(1, 2 ** n - 1)
            dirty_anc_available = n + 1 - index_last_1(a_value)
            clean_anc_available = 0
    ...
    def test_addition_hrs_incrementer(self):
        ...
        for i in range(0, 10):
            ...
            x_value = Random().randint(1, 2 ** n - 1)
            a_value = Random().randint(1, 2 ** n - 1)
            dirty_anc_available = n - index_last_1(a_value)
            clean_anc_available = 0
