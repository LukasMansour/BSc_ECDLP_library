...
class HRSConstantAdderTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_addition_hrs_incrementer(self):
        ...
        for i in range(0, 10):
            ...
            dirty_anc_available = max(n - index_last_1(a_value) - n // 2,
                                      1)  # here we start to see why this incrementer is so powerful.
            clean_anc_available = 0
    ...
    def test_controlled_addition_gidney_incrementer(self):
        ...
        for i in range(0, 10):
            ...
            x_value = Random().randint(1, 2 ** n - 1)
            a_value = Random().randint(1, 2 ** n - 1)
            dirty_anc_available = max(n - n // 2 - c, 2)
            clean_anc_available = 0
    ...
    def test_controlled_addition_hrs_incrementer(self):
        ...
        for i in range(0, 10):
            ...
            x_value = Random().randint(1, 2 ** n - 1)
            a_value = Random().randint(1, 2 ** n - 1)
            dirty_anc_available = max(n - index_last_1(a_value) - n // 2 - c, 2)
